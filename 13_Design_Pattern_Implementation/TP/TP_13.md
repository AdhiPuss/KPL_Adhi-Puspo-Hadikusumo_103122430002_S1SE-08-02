...
Design pattern yang kita gunakan adalah MVC (Model-View-Controller). Pada kode di bawah ini, digunakanlah design pattern MVC, yaitu memisahkan program menjadi tiga bagian utama. Folder Model digunakan untuk mengatur data dan relasi database, seperti data kuda, peternakan, lisensi, dan transaksi. Untuk Folder Controller digunakan untuk mengatur logika program, misalnya menentukan data kuda yang boleh dilihat oleh admin, peternak, atau pembeli. Lalu ada Folder View digunakan untuk menampilkan data ke halaman web menggunakan Blade.

Jadi dengan menggunakan pola ini, kode menjadi rapi karena bagian database, proses, dan tampilan tidak dicampur dalam satu file. Misalnya, ketika ingin mengubah tampilan halaman data kuda, cukup mengubah file view. Jika ingin mengubah aturan data yang tampil, cukup mengubah controller nya saja. contoh code tubes ada di repo teman sekelompok saya:
